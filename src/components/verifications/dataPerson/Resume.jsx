    ...
    return (
        <div className="flex flex-col space-y-10 dark:text-white">
            <div className="flex space-x-10 w-full">
                <Image src={person.auditTrailImage? `data:image/png;base64,${person.auditTrailImage}` : unknow}  alt="" width={100} height={100} className="size-40 aspect-square rounded-full object-cover" />
